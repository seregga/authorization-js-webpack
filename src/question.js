export class Question {
    static create(question) {
        return fetch('https://app-only-js-webpack-default-rtdb.europe-west1.firebasedatabase.app/question.json', {
            method: 'POST',
    ...
    static fetch(token) {
        ...
        return fetch(`https://app-only-js-webpack-default-rtdb.europe-west1.firebasedatabase.app/question.json?auth=${token}`)
            .then(response => response.json())
            .then(response => {
